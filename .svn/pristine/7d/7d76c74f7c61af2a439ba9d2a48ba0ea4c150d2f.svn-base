...
public class Two_Position_Remove {
	...
	public Two_Position_Remove(Game_info gg) {
		AfterChangePane = gg.GetCurrentPane();
		this.gg = gg;
	}
	...
	public void Remove(Position p1,Position p2) {
		//交换
		Adjust.ChangePane(AfterChangePane, p1, p2);
