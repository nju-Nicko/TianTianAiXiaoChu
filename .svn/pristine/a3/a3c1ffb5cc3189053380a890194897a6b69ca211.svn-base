...
public class LoginUI {
	...
	private void initialize() {
		...
		frame.addMouseMotionListener(new MouseMotionListener() {
			public void mouseMoved(MouseEvent e) {
				...
				if (in1) {
					...
					ext.addItem("    ×¢²áÕÊºÅ");
					ext.addItem("    ÐÞ¸ÄÃÜÂë");
					ext.addItem("    ÀëÏßÊÔÍæ");
		...
		lblNewLabel.setToolTipText("¹Ø±ÕÌìÌì°®Ïû³ý");
		...
		lblNewLabel_1.setToolTipText("×îÐ¡»¯ÌìÌì°®Ïû³ý");
		...
		lblNewLabel_2.setToolTipText("¿ª·¢ÈËÔ±");
		...
		checkBox = new JCheckBox("¼Ç×¡ÃÜÂë");
		checkBox.setBounds(41, 208, 100, 30);
		checkBox.setForeground(Color.white);
		checkBox.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
		...
		final JLabel lblNewLabel_6 = new JLabel("ÔÄ¶ÁÓÃ»§Ð­Òé");
		lblNewLabel_6.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 11));
		...
		lblNewLabel_6.addMouseListener(new MouseListener() {
			...
			public void mouseEntered(MouseEvent e) {
				frame.setCursor(new Cursor(Cursor.HAND_CURSOR));
				lblNewLabel_6.setFont(new Font("Î¢ÈíÑÅºÚ", Font.ITALIC, 11));
