		...
		public MyMenuItem(String name) {
			...
			addMouseListener(new MouseListener() {
				...
				public void mouseReleased(MouseEvent e) {
					if (MyMenuItem.this.name.equals("删除")) {
						Startup.net.sendMessage(new RemoveFriendMessage(Startup.window.uif.name,Startup.window.mainframe.theFriend));
						Startup.window.mainframe.fl.on.updateInfo();
						Startup.window.mainframe.fl.off.updateInfo();
						Startup.window.mainframe.fl.repaint();
					}
				}
