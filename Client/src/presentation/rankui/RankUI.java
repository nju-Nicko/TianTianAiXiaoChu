...
public class RankUI {
	...
	public JPanel rankPanel() throws FontFormatException, IOException {
		...
		title.setFont(new Font("ÃÔÄã¼ò²Êµû",Font.PLAIN,35));
